...
for index in tqdm(range(len(sigma_space))):
        ...
        mo = models.Ricker_Multi(set_seed=True)
        ...
        mricker_det_train = models.Ricker_Single(set_seed=True)
        ...
        mricker_det_test = models.Ricker_Single(set_seed=True)
        ...
        mricker_sto_train = models.Ricker_Single(set_seed=True)
        ...
        mricker_sto_test = models.Ricker_Single(set_seed=True)
